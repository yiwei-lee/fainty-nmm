...
public class Board {
	...
	public boolean checkNewMill(Color color, int x, int y) {
		...
		if (x==0 || x==6){
			...
			if (board[x][2]==color && board[x][3]==color && board[x][3]==color) newMill = true;
		}else{
			if (board[3][0]==color && board[3][1]==color && board[3][2]==color) newMill = true;
			else if (board[3][4]==color && board[3][5]==color && board[3][6]==color) newMill = true;
		}
		...
		if (y==0 || y==6){
			...
			if (board[2][y]==color && board[3][y]==color && board[3][y]==color) newMill = true;
		}else{
			if (board[0][3]==color && board[1][3]==color && board[2][3]==color) newMill = true;
			else if (board[4][3]==color && board[5][3]==color && board[6][3]==color) newMill = true;
		}
		return newMill;
	}
